...
ci1 = models.CollectionArticle(collection_id=c.id, article_id=a1.id, order=0)
ci2 = models.CollectionArticle(collection_id=c.id, article_id=a2.id, order=1)
ci3 = models.CollectionArticle(collection_id=c.id, article_id=a3.id, order=2)
